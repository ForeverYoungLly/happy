          ...
          <el-col :span="8" :offset="6">
            <el-input v-model="searchId" placeholder="请输入id">
              ...
              <el-popover
                ...
                trigger="hover"
                content="点击重置">
                <el-button slot="reference" icon="el-icon-refresh" @click="resetForm"></el-button>
              </el-popover>
      ...
      <el-table :data="templateData" style="width: 100%" stripe>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button type="primary" size="small" @click="openTemplate(scope)">查看</el-button>
            <el-button type="primary" size="small" @click="moveAway(scope)">删除</el-button>
            <el-button @click="showMessage(scope)" type="primary" size="small">导入</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
    <!-- 模板部分气泡框 -->
    <el-dialog title="提示" :visible.sync="templatedialogVisible" width="30%">
